-- Active: 1785826856181@@127.0.0.1@3306@practice2
/*[실습] 제출용 */
...
# UNSIGNED는 음수 저장금지 / 0 이상의 값만 저장하도록 만듦.
...
-- constraint 를 붙이지 않아도, [테이블명]_ibfk_[숫자] 형태의 PRIMARY KEY를 자동으로 생성
...
CREATE Table comments(
    ...
    board_id INT,
    FOREIGN KEY(board_id) REFERENCES members(member_id),
