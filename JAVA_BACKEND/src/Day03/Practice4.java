...
출력 예시: 성공 */
 ...
 //1. 
    ...
    // int 총점 = 점수1 + 점수2;
    // System.out.println(총점 >=90 ? "성공" : "실패");
...
//2.
    ...
    // System.out.print("두 번째 점수: ");      
    // int 점수2 = scan.nextInt();
    // if(점수1 > 점수2){System.out.println("더 큰 수:"+점수1);}
    // else{System.out.println("더 큰 수:"+점수2);}
...
//3.
        ...
        // boolean 결과 = 아이디.equals("admin") && 비밀번호.equals("1234");
        // System.out.println(결과 == true ? "로그인성공" : "로그인실패");
...
//4.
        ...
        // String 비번 = scan.next();
        // if(비번.length()< 8){System.out.println("보안 등급: 약함 (8자 이상으로 설정해주세요.)");}
        // else if(비번.length()<12){System.out.println("보안 등급: 보통");}
...
//13.
        ...
        // else{System.out.println(연도+"년은 윤년이 아닙니다.");}
...
//15. 
        ...
        // int result = (player1 - player2 + 3) % 3;
