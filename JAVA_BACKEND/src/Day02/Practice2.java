...
public class Practice2 {
    ...
    double z = 3.141592;
    int a2 = (int) z ;
    System.out.printf("원본 double의 값:%f\n",z);
    ...
    // int b3 = (int)a3;
    // System.out.printf("당신의 키는 약 %d 이군요.\n",b3);
    ...
    int c4 = sc.nextInt();
    double d4 = (a4 + b4 + c4)/3;
    System.out.printf("평균 결과:%.16f\n",d4);
    }
}
...
/*문제 3: Scanner를 이용해 사용자의 키를 double 타입(예: 178.5)으로 입력받은 후, 이 값을 int 타입으로 강제 변환하여 
"당신의 키는 약 OOOcm 이군요." 라고 정수 부분만 출력하시오.
입력 예시:
키를 입력하세요: 178.5
출력 예시:
당신의 키는 약 178cm 이군요. */
