...
public class Practice1 {
    public static void main(String[] args) {
        ...
        //3. 
        String name = "jin";    int age2 =26;   double height = 173;   String motto = "모또모또";
    ...
    "        ||_/=\\\\__|        ||_/=\\\\__|        ||_/=\\\\__|\n"
        ...
        // int 나이출력 = sc.nextInt();
        // System.out.printf("%s님의 나이는 %d세 입니다.",이름출력,나이출력);

        //9.
        // System.out.print("게시물 번호:");
        // int 번호 = sc.nextInt(); sc.nextLine();
        // System.out.print("제목:"); String 제목 = sc.nextLine();
        // System.out.print("내용:"); String 내용 = sc.nextLine();
        // System.out.printf("\n[%d번 게시물]\n제목: %s\n내용: %s\n", 번호, 제목, 내용);

        //10.
        // System.out.println("성별을 입력하세요(남/여)");
        // char 성별 = sc.next().charAt(0);
        // System.out.printf("입력하신 성별은 '%c'입니다.",성별);
